    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <h2 class="text-2xl font-semibold text-white text-center">Modifier le modèle</h2>
                    ...
                    <div>
                        ...
                        <div class="mb-2 text-sm text-gray-300">
                            ...
                            <div class="flex flex-wrap gap-2 mt-1">
                                @foreach (['{nom}', '{prenom}', '{adresse}', '{ville}', '{code_postal}', '{email}', '{telephone}', '{nom_proprietaire}', '{prenom_proprietaire}', '{adresse_proprietaire}', '{nom_du_box}', '{adresse_du_box}', '{prix_journalier}', '{prix_hebdomadaire}', '{prix_mensuel}', '{ville_proprietaire}', '{date_du_jour}', '{date_de_debut}', '{date_de_fin}'] as $variable)
                        ...
                        <textarea id="content" class="block mt-1 w-full rounded-md bg-gray-900 border-none text-white min-h-[400px]" name="content" required>{{ old('content', $contractModel->content) }}</textarea>
                    </div>
